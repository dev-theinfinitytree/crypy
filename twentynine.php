...
if($data!=="twentynine.php"){
    ...
    if(isset($_POST['ans']) && !empty($_POST['ans'])){
        $ans=$_POST['ans'];
        $obj=new \game\game();
        $correct=$obj->check_answer(29,$ans);
        if($correct==1){
            $obj->change_level();
            header("Refresh:0");
        }
    ...
    <html>
    <head>
        <title>Crupthunter:: Level 29</title>
        <!--Custom Theme files-->
    ...
    <!-- main -->
    <div class="main">
        <h1>This is the last level. If you can cross it you will become a winner. If you dont, you will be a looser (actually not).
        Mind your steps carefully.</h1>
        <div class="signin-form">
            <form action="" method="post">
                <ul>
                    <li>

                        <p>How long you can type?</p>
                    </li>
                    <li>
                        <img src="assets/img/twentynine.jpg">
            ...
            <a href="#" class="text">Difficulty: Moderate</a>
        </div>
    </div>
    <!--//main -->
    <div class="copyright">
