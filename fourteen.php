...
if($data!=="fourteen.php"){
    ...
    if(isset($_POST['ans']) && !empty($_POST['ans'])){
        $ans=$_POST['ans'];
        $obj=new \game\game();
        $correct=$obj->check_answer(14,$ans);
        if($correct==1){
            $obj->change_level();
            header("Refresh:0");
        }
    ...
    <html>
    <head>
        <title>Crupthunter:: Level 14</title>
        <!--Custom Theme files-->
    ...
    <!-- main -->
    <div class="main">
        <h1>Level 14 Question</h1>
        <div class="signin-form">
            <form action="" method="post">
                <ul>
                    <li>

                        <p>Brendon McCullum + Mohammad Amir</p>
                    </li>
                    <li>
                        <img src="assets/img/fourteen1.jpg">
            ...
            <a href="#" class="text">Difficulty: Silly</a>
        </div>
    </div>
    <!--//main -->
    <div class="copyright">
