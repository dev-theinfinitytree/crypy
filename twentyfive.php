...
if($data!=="twentyfive.php"){
    ...
    if(isset($_POST['ans']) && !empty($_POST['ans'])){
        $ans=$_POST['ans'];
        $obj=new \game\game();
        $correct=$obj->check_answer(25,$ans);
        if($correct==1){
            $obj->change_level();
            header("Refresh:0");
        }
    ...
    <html>
    <head>
        <title>Crupthunter:: Level 25</title>
        <!--Custom Theme files-->
    ...
    <div class="main">
        ...
        <div class="signin-form">
            ...
            <a href="#" class="text">Difficulty: "I wont tell"</a>
        </div>
    </div>
    <!--//main -->
    <div class="copyright">
