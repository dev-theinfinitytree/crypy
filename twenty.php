...
if($data!=="twenty.php"){
    ...
    if(isset($_POST['ans']) && !empty($_POST['ans'])){
        $ans=$_POST['ans'];
        $obj=new \game\game();
        $correct=$obj->check_answer(20,$ans);
        if($correct==1){
            $obj->change_level();
            header("Refresh:0");
        }
    ...
    <html>
    <head>
        <title>Last Level (Just Kidding) </title>
        <!--Custom Theme files-->
    ...
    <!-- main -->
    <div class="main">
        <h1>Last Level (Just Kidding)</h1>
        <div class="signin-form">
            <form action="" method="post">
                <ul>
                    <li>

                        <p>Leaves, Branches, Root</p>
                    </li>
                    <li>
                        <img src="assets/img/twenty.jpg">
            ...
            <a href="#" class="text">Difficulty: Very Easy</a>
        </div>
    </div>
    <!--//main -->
    <div class="copyright">
