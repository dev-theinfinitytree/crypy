...
if($data!=="fifth.php"){
    ...
    if(isset($_POST['ans']) && !empty($_POST['ans'])){
        $ans=$_POST['ans'];
        $obj=new \game\game();
        $correct=$obj->check_answer(5,$ans);
        if($correct==1){
            $obj->change_level();
            header("Refresh:0");
        }
    ...
    <!-- main -->
    <div class="main">
        <h1>Level 5 Question</h1>
        <div class="signin-form">
            <form action="" method="post">
                <ul>
                    <li>

                        <p>You can solve it... if you're strong enough!</p>
                    </li>
                    <li>
                        <img src="assets/img/fifth.jpg">
            ...
            <a href="#" class="text">Difficulty: Easy</a>
        </div>
    </div>
    <!--//main -->
    <div class="copyright">
