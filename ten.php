...
if($data!=="ten.php"){
    ...
    if(isset($_POST['ans']) && !empty($_POST['ans'])){
        $ans=$_POST['ans'];
        $obj=new \game\game();
        $correct=$obj->check_answer(10,$ans);
        if($correct==1){
            $obj->change_level();
            header("Refresh:0");
        }
    ...
    <html>
    <head>
        <title>Crupthunter:: Level 10</title>
        <!--Custom Theme files-->
    ...
    <!-- main -->
    <div class="main">
        <h1>Level 10 Question</h1>
        <div class="signin-form">
            <form action="" method="post">
                <ul>
                    <li>

                        <p>Recall Level '1704' oopss..sorry Level 2</p>
                    </li>
                    <li>
            ...
            <a href="#" class="text">Difficulty: Ummm....Let me think</a>
        </div>
    </div>
    <!--//main -->
    <div class="copyright">
